...
import sit.int221.repositories.primary.Statuses3Repository;
...
public class Statuses3Service {
    ...
    @Autowired
    Task2Repository task3Repository;
    @Autowired
    ...
    public Statuses3 findStatusById(Integer statusID) {
        return statuses3Repository.findById(statusID).orElseThrow(
...
//    public Statuses3 insertStatus(NewStatusDTO newStatusDTO) {
